<%-- 
    Document   : QuestionEdit
    Created on : Jun 16, 2022, 11:01:44 AM
                    ...
                    <c:if test="${error == null}">
                        <div class="content">
                            <div class="intro-y flex items-center mt-8">
                                <h2 class="text-lg font-medium mr-auto">Question Update</h2>
                            </div>
                            <div class="grid grid-cols-12 gap-6 mt-5">

                                <div class="intro-y col-span-12 lg:col-span-6">                       
                                     <a href="QuestionList" class="btn-outline-primary mb-10">Back To List</a>
                                    <div class="intro-y box p-5">
                                        ...
                                        <form action = "QuestionEdit" method = "POST">
                                            ...
                                            <div>
                                                ...
                                                <input id="crud-form-1" name="QuestionName" type="text" class="form-control w-full" placeholder="Input Question Name" value="${Question.getQuestionName()}"required="true" > 
                                            </div> 
                                            <!--                                Explanation-->
                                                ...
                                                <div>
                                                    <form class="" method="GET" action="AnswerEdit">
                                                        ...
                                                        <div><label for="crud-form-1" class="form-labelmt-2">AnswerContent</label>
                                                            <textarea id="crud-form-1" name="AnswerContent" type="text" class="form-control w-full" placeholder="Input Answer Content " rows="4" >${ans.getAnswerContent()}</textarea> </div></td>
                                                        <div><label for="crud-form-" class="form-label mt-2">AnswerComent</label><textarea id="crud-form-1" name="AnswerComent" type="text" class="form-control w-full" rows="4" placeholder="Input Comment "  >${ans.getComment()}</textarea></div></td>
                                                        ...
                                                        <div class="text-center" colspan="2">
                                                            <input onclick="return confirm(`Delete ${ans.getID()} - Question: ${Question.getId()}`);" type="submit"  name="submit" value="Delete"class="btn-outline-danger mr-1">
                                                            <input onclick="return confirm(`Update ${ans.getID()} - Question: ${Question.getId()}`);" type="submit"  name="submit" value="Update" class="btn-outline-success ml-1">
                                                        </div>
                                                    </form>                        
                                                </div>
                                            </div>
