        ...
        <div id="root">
            <div class="py-5 md:py-0">
                ...
                <div class="flex overflow-hidden">
                        ...
                        <div class="card p-4 mb-4 mt-5 table-wrapper">
                            <div class="d-flex justify-content-between align-items-sm-center flex-column flex-sm-row mb-4">
                                <div class="me-4 mb-3 mb-sm-0">
                                    <h1 class="mb-0 text-bold text-capitalize">Quizz List</h1>
                            ...
                            <div class="card-body table-responsive">
                                <c:if test="${error!= null}">
                                    <div class="alert-danger"><label class="">${error}</label></div>
                                    </c:if>
                                <div class="">
                                    <a href="CreateQuiz"><button class="btn btn-primary mb-3">Create Quiz</button></a>
                                    <div class="text-right mb-2">
                                        <form action="QuizzesList" method="GET">
                            ...
                            <table class="table table-striped table-hover table-bordered padding-0">
                                <thead class="table-primary text-center">
                                    <tr>
                                        <th><button class="bg-transparent border-0" type="submit" name="sort" value="id"><b>Quiz ID</b><i class="fa-solid fa-sort"></i></button></th>
                                        <th><button class="bg-transparent border-0" type="submit" name="sort" value="QuestionName"><b>Quiz Name</b><i class="fa-solid fa-sort"></i></button></th>
                                        <th><button class="bg-transparent border-0" type="submit" name="sort" value="Question_Detail"><b>Subject Name</b><i class="fa-solid fa-sort"></i></button></th>
                                        <th><button class="bg-transparent border-0" type="submit" name="sort" value="Status"><b>Duration</b><i class="fa-solid fa-sort"></i></button></th>
                                        <th><button class="bg-transparent border-0" type="submit" name="sort" value="Status"><b>Pass Rate</b><i class="fa-solid fa-sort"></i></button></th>
                                        <th colspan="2">Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <c:choose>
                                        <c:when test="${requestScope.LstQuizz==null||requestScope.LstQuizz.size()==0}">
                                            <tr><td class="dataTables-empty" colspan="7">No results match your search query</td></tr>
                                        </c:when>
                                        <c:otherwise>
                                            <!--FILL TABLE-->
                                            <c:forEach var="listQuizz" items="${requestScope.LstQuizz}">
                                                <tr>
                                                    <td>${listQuizz.getQuiz().getLessionID()}</td>
                                                    <td>${listQuizz.getLession().getName()}</td>
                                                    <td>${listQuizz.getSubject().getSubjectName()}</td>
                                                    <td>${listQuizz.getQuiz().getDuration()}</td>
                                                    <td>${listQuizz.getQuiz().getPass_rate()}</td>
                                                    <td class="text-center">
                                                        <a href="QuizDetail?id=${listQuizz.getQuiz().getLessionID()}">
                    ...
                    <div class="test-right mt-3">
                        <c:forEach var = "i" begin="1" end="${endP}" > 
                            <a href="QuizzesList?index=${i}&SearchKEY=${searchKey}&order=${order}&filter=${filter}">${i}</a>
                        </c:forEach>
                    </div>
                        </div>
                    </div>
