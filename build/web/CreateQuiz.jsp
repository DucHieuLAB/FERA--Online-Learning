                    ...
                    <c:if test="${error == null}">
                        <div class="content">
                            <div class="intro-y flex items-center mt-8">
                                <h2 class="text-lg font-medium mr-auto">Quiz Create</h2>
                            </div>
                            <a href="QuizzesList" class="btn-outline-primary mb-5">Back To List</a>
                            <div class="grid grid-cols-12 gap-6 mt-5">
                                <div class="intro-y col-span-12 lg:col-span-6">                       
                                    <div class="intro-y box p-5">
                                        ...
                                        <form method="GET" action="CreateQuiz">
                                            <!--SubjectID-->
                                            <div><label for="select-LessionID" class="form-label">Subject</label> 
                                                <select id="select-LessionID" class="form-select" aria-label="Default select example2"  name="SubjectID" onchange="this.form.submit()">                          
                                        ...
                                        <form method="GET" action="CreateQuiz">                      
                                            ...
                                            <div>
                                                ...
                                                <select id="select-LessionID" class="form-select" aria-label="Default select example2"  name="LessionID" onchange="this.form.submit()">                          
                                                    <c:forEach items="${LstLession}" var="l">
                                                        <option value="${l.getID()}" ${LessionID == l.getID()? "selected":""} >${l.getName()}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </form>
                                        ...
                                        <form action = "CreateQuiz" method = "POST">
                                            <input name="SelectedlessionID" value="${LessionID}" hidden>
                                            <!--Duration-->
                                                ...
                                                <div class="mt-2">
                                                    <div class="ck ck-reset ck-editor ck-rounded-corners" role="application" dir="ltr" lang="en" aria-labelledby="ck-editor__label_e3d2f723ba2e009e8e310aea28e50f40d">
                                                        <div class="ck ck-editor__main" role="presentation" >                
                                                            <input class="form-control form-input " name="Duration" id="select-Duration" min="0" type="number" required >
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>     
                                            ...
                                            <div class="mt-3"><label>Pass Rate (%)</label>
                                                <div class="mt-2">
                                                    <div class="ck ck-reset ck-editor ck-rounded-corners" role="application" dir="ltr" lang="en" aria-labelledby="ck-editor__label_e3d2f723ba2e009e8e310aea28e50f40d">
                                                        <div class="ck ck-editor__main" role="presentation" >                
                                                            <input class="form-control form-input " name="Pass_rate" id="select-Duration" min="0" type="number" required >
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mt-3"><label>Description</label>
                                                <div class="mt-2">
                                                    <div class="ck ck-reset ck-editor ck-rounded-corners" role="application" dir="ltr" lang="en" aria-labelledby="ck-editor__label_e3d2f723ba2e009e8e310aea28e50f40d">
                                                        <div class="ck ck-editor__main" role="presentation" >
                                                            <textarea class="form-control ck-blurred   " lang="en" dir="ltr" rows="4" role="textbox" aria-label="Rich Text Editor, main" contenteditable="true" aria-readonly="true" name="Description"  >
                                                            </textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="mt-3"><label>Media</label>
                                                <div class="mt-2">
                                                    <div class="ck ck-reset ck-editor ck-rounded-corners" role="application" dir="ltr" lang="en" aria-labelledby="ck-editor__label_e3d2f723ba2e009e8e310aea28e50f40d">
                                                        <div class="ck ck-editor__main" role="presentation" >                
                                                            <input class="form-control form-input " name="Media" id="select-Duration"  type="text"  >
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--NumOfQuestion-->
                                            <c:if test="${NumOfQuestion == null}"> 
                                                <label>Please Select Subject and Lession first</label>
                                            </c:if>
                                            <div class="mt-3"><label>Number Of Question Max = (${NumOfQuestion != null ?NumOfQuestion:""})</label>
                                                <div class="mt-2">
                                                    <div class="ck ck-reset ck-editor ck-rounded-corners" role="application" dir="ltr" lang="en" aria-labelledby="ck-editor__label_e3d2f723ba2e009e8e310aea28e50f40d">
                                                        <div class="ck ck-editor__main" role="presentation" >                
                                                            <input class="form-control form-input " name="NumOfQuestion" id="select-Duration" min="1" max="${NumOfQuestion != null ?NumOfQuestion:""}" type="number" required >
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="text-center mt-5 mb-5">
                                                <button type="submit" class="btn btn-outline-success w-24 mr-1">Submit</button> 
                                            </div>
                                        </form>
