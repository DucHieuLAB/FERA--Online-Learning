<%-- 
    Document   : newjsp
    Created on : Jun 27, 2022, 10:12:37 PM
                        ...
                        <div class="card p-4 mb-4 mt-5 table-wrapper">
                            <div class="d-flex justify-content-between align-items-sm-center flex-column flex-sm-row mb-4">
                                <div class="me-4 mb-3 mb-sm-0">
                                    <h1 class="mb-0 text-bold text-capitalize">Quizz Detail</h1>
                                ...
                                <div class="intro-y col-span-12 lg:col-span-6">                       
                                    <div class="intro-y box p-5">
                                        <c:if test="${message != nul}">
                                            ...
                                            <!--SubjectID-->
                                            <div><label for="select-LessionID" class="form-label">Subject</label> 
                                                <select id="select-LessionID" class="form-select" aria-label="Default select example2"  name="SubjectID" onchange="this.form.submit()" disabled>                          
                                                    <c:forEach items="${lstSubject}" var="s">
                                                        <option value="${s.getSubjectID()}" ${quizzList.getSubject().getSubjectID() == s.getSubjectID()? "selected":""} >${s.getSubjectName()}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>  
                                            <!--LessionID-->
                                            <div>
                                                ...
                                                <label for="select-LessionID" class="form-label">Lession</label> 
                                                <select id="select-LessionID" class="form-select" aria-label="Default select example2"  name="LessionID" onchange="this.form.submit()" disabled>                          
                                                    <c:forEach items="${LstLession}" var="l">
                                                        <option value="${l.getID()}" ${quizzList.getLession().getID() == l.getID()? "selected":""} >${l.getName()}</option>
                                                    </c:forEach>
                                                </select>
                                            </div> 
                                             <form action="QuizDetail" method="POST">
                                            <input type="text" name="LessionID" value="${quizzList.getLession().getID()}" hidden>
                                            <!--Duration-->
                                            <div class="mt-3"><label>Duration (minutes)</label>
                                                <div class="mt-2">
                                                    <div class="ck ck-reset ck-editor ck-rounded-corners" role="application" dir="ltr" lang="en" aria-labelledby="ck-editor__label_e3d2f723ba2e009e8e310aea28e50f40d">
                                                        <div class="ck ck-editor__main" role="presentation" >                
                                                            <input class="form-control form-input " name="Duration" id="select-Duration" min="0" type="number"  value="${quizzList.getQuiz().getDuration()}" >
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>     
                                            <!--Pass_rate-->
                                            <div class="mt-3"><label>Pass Rate (%)</label>
                                                <div class="mt-2">
                                                    <div class="ck ck-reset ck-editor ck-rounded-corners" role="application" dir="ltr" lang="en" aria-labelledby="ck-editor__label_e3d2f723ba2e009e8e310aea28e50f40d">
                                                        <div class="ck ck-editor__main" role="presentation" >                
                                                            <input class="form-control form-input " name="Pass_rate" id="select-Duration" min="0" type="number"  value="${quizzList.getQuiz().getPass_rate()}" >
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mt-3"><label>Description</label>
                                                <div class="mt-2">
                                                    <div class="ck ck-reset ck-editor ck-rounded-corners" role="application" dir="ltr" lang="en" aria-labelledby="ck-editor__label_e3d2f723ba2e009e8e310aea28e50f40d">
                                                        <div class="ck ck-editor__main" role="presentation" >
                                                            <textarea class="form-control ck-blurred   " lang="en" dir="ltr" rows="4" role="textbox" aria-label="Rich Text Editor, main" contenteditable="true" aria-readonly="true" name="Description"   >${quizzList.getQuiz().getDescription()}
                                                            </textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <!--Media-->
                                            <div class="mt-3"><label>Media</label>
                                                <div class="mt-2">
                                                    <div class="ck ck-reset ck-editor ck-rounded-corners" role="application" dir="ltr" lang="en" aria-labelledby="ck-editor__label_e3d2f723ba2e009e8e310aea28e50f40d">
                                                        <div class="ck ck-editor__main" role="presentation" >                
                                                            <input class="form-control form-input " name="Media" id="select-Duration"  type="text"  value="${quizzList.getQuiz().getMedia()}" >
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="text-center mt-3"><button class="btn btn-outline-primary" type="submit" name="Edit">Edit</button></div>
                                        </form>

                                        <!--NumOfQuestion-->
                                        <div class="mt-3"><label>Number Of Question </label>
                                            <div class="mt-2">
                                                <div class="ck ck-reset ck-editor ck-rounded-corners" role="application" dir="ltr" lang="en" aria-labelledby="ck-editor__label_e3d2f723ba2e009e8e310aea28e50f40d">
                                                    <div class="ck ck-editor__main" role="presentation" >                
                                                        <input class="form-control form-input " name="NumOfQuestion" id="select-Duration" min="1" max="${NumOfQuestion != null ?NumOfQuestion:""}" type="number" readonly value="${quizzList.getQuiz().getNumOfQuestion()}" >
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="d-flex justify-content-between align-items-sm-center flex-column flex-sm-row mb-4 mt-3">
                                <div class="me-4 mb-3 mb-sm-0">
                                    <h1 class="mb-0 text-bold text-capitalize">List Question</h1>
                                    <div class="small" id="nowTime">
                                    </div>
                                </div>
                            </div>
                            <div class="card-body table-responsive">
                                ...
                                <table class="table table-striped table-hover table-bordered padding-0">
                                    ...
                                    <tbody>
                                        <c:forEach var="question" items="${quizzList.getLstQuestion()}">
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="QuizEdit?QuestionID=${question.getId()}&QuizID=${quizzList.getQuiz().getLessionID()}">
                                                        <i style="color:#FF0000" data-feather="Delete">Delete</i>
                                                    </a>
                                    ...
                                    <div>
                                        <input name="QuizID" value="${quizzList.getQuiz().getLessionID()}" hidden>
                                        <label for="select-LessionID" class="form-label">Question</label> 
                                        <select id="select-LessionID" class="form-select" aria-label="Default select example2"  name="QuestionID" >                          
                                            <c:forEach items="${LstQuestion}" var="q">
                                                <option value="${q.getId()}"  >${q.getQuestionName()}</option>
                                            </c:forEach>
                                        </select>
                                    </div> 
